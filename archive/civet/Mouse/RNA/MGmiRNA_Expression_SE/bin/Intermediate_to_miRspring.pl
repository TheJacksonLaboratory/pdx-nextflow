...
my $JavaScriptTemplateFile      = "/projects/keshar/Functional_miR_pipeline/MGmiRPipe/bin/javascriptTEMPLATE.txt";	# Set the full path so that you do not have to execute this script within the installed directory.
####-------------------------------------------------------------------------------------------------------------------------------
