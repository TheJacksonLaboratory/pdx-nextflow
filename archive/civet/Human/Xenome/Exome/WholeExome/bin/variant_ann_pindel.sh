...
sed 's/SVTYPE=/SV=/i' $file > mod.vcf
vep -verbose -debug -i mod.vcf  -o out_vep.vcf -offline --af --af_1kg \
    --af_esp  --af_exac  --vcf  --force_overwrite --no_stats \
